...
public class PersonUnitRuleUnit extends AbstractRuleUnit<PersonUnit> {

    @javax.inject.Inject()
    public PersonUnitRuleUnit(org.kie.kogito.Application app) {
        super(PersonUnit.class.getCanonicalName(), app);
    }

    public org.acme.PersonUnitRuleUnitInstance internalCreateInstance(PersonUnit value) {
        return new org.acme.PersonUnitRuleUnitInstance(this, value, createLegacySession());
    }
    ...
    private KieSession createLegacySession() {
        ...
        org.drools.core.impl.InternalKnowledgeBase kb = org.drools.modelcompiler.builder.KieBaseBuilder.createKieBaseFromModel(new org.acme.Rules49F42D626E9988546A3691D6941DC956_PersonUnit(), ruleBaseConfig);
